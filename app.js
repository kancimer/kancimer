...
const computerDots = document.querySelector('.loading');
...
const game = () =>{
    buttons.forEach(btn =>{
        btn.addEventListener('click',(e)=>{
			computerShowIcon.style.display="none";
			computerDots.style.display="flex";
        // Random rock paper scissor for the computer and the player
           let clickedBtn = e.target.className;
           showIcon.className = clickedBtn;
		   setTimeout( function(){
			   computerDots.style.display="none";
			   computerShowIcon.style.display="flex";
          ...
          // if it's not a Tie.
               ...
               text.style.color = '#901FB2';
               text2.innerHTML = text.innerHTML;
               text2.style.color = '#901FB2';
